...
//MARK: 日线/周线/月线 行情数据:
//以日期为主键值, 查询单个股票历史数据
class TushareProMarketDataClassOfDate: Object, Mappable {
...
class TushareProMarketDataClassOfStock: Object, Mappable {
...
//MAKR: 复权因子
class TushareProAdjustedFactorClass: Object, Mappable {
...
//MARK: 每日指标
class TushareProDailyIndication: Object, Mappable {
...
//MARK: 个股资金流向
class TushareProMoneyFlow: Object, Mappable {
